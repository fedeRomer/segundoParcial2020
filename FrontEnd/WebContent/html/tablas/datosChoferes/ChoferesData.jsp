...
<body>
	...
	<table id="datatable" class="table table-striped table-bordered table-sm" style="width:100%">
		<tr>
			<th style="color: black" onclick="sortTable(0)">Nombre</th>
			<th style="color: black" onclick="sortTable(1)">Apellido</th>
			<th style="color: black" onclick="sortTable(2)">Dni</th>
			<th style="color: black" onclick="sortTable(3)">Fecha de nacimiento</th>
			<th style="color: black" onclick="sortTable(4)">Categoria</th>
			<th style="color: black" onclick="sortTable(5)">Telefono</th>
