...
<link href="${pageContext.request.contextPath}/html/tablas/datosChoferes/datatableStyle.css" rel="stylesheet">
</head>
...
<body>
    ...
    <table border="1" width="100%">
        ...
        <c:forEach var="choferes" items="${lista}">
            <tr>
                <td style="color:white"><c:out value="${choferes.nombre}" /></td>
                <td style="color:white"><c:out value="${choferes.apellido}" /></td>
                <td style="color:white"><c:out value="${choferes.dni}" /></td>
                <td style="color:white"><c:out value="${choferes.fechaDeNacimiento}" /></td>
                <td style="color:white"><c:out value="${choferes.categoria}" /></td>
                <td style="color:white"><c:out value="${choferes.telefono}" /></td>
